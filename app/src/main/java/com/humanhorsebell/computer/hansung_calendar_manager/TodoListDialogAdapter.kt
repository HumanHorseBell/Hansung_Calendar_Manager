...
class TodoListDialogAdapter(context: Context, item: ArrayList<Todo>): BaseAdapter() {
    private val context = context
    private val item = item

    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        var view = LayoutInflater.from(context).inflate(R.layout.dialog_todo_list, parent, false)
        val listView = view.findViewById<View>(R.id.textViewName) as CheckBox
